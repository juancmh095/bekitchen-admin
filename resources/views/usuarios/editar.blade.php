          ...
          <div class="row justify-content-lg-center">
            <div class="col-lg-10">
              ...
              <div class="card card-lg mb-3 mb-lg-5">
                ...
                <!-- End Header -->
                <form action="{{route('updateUsuario')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <!-- Body -->
                  <div class="card-body">
                    <!-- Form -->
                    <div class="mb-4">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <input type="hidden" name="media" value="{{$usuario->foto?$usuario->foto:'N/A'}}">
                    ...
                    <div class="mb-4">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <input type="text" class="form-control" name="nombre" id="nameSucursal" placeholder="Ingrese el nombre" value="{{$usuario->nombre}}">
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="mb-4">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <input type="text" class="form-control" name="ap" id="nameSucursal" placeholder="Ingrese el nombre" value="{{$usuario->ap_paterno}}">
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="mb-4">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <input type="text" class="form-control" name="am" id="nameSucursal" placeholder="Ingrese el nombre" value="{{$usuario->ap_materno}}">
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="mb-4">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <input type="email" class="form-control" name="correo" id="nameSucursal" placeholder="Ingrese email" value="{{$usuario->email}}">
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="mb-4">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <input type="phone" class="form-control" name="telefono" id="nameSucursal" placeholder="Ingrese el nombre" value="{{$usuario->telefono}}">
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="mb-4">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <input type="password" class="form-control" name="password" id="nameSucursal" placeholder="*********" value="{{$usuario->password}}">
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="mb-4">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <input type="text" class="form-control" name="direccion" id="nameSucursal" placeholder="Ingrese el nombre" value="{{$usuario->direccion}}">
                      </div>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="mb-4">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <select id="" class="form-control" name="tipo" value="{{$usuario->tipo}}">
                  ...
                  <div class="card-footer d-flex justify-content-end align-items-center gap-3">
                    <a type="button" class="btn btn-white" href="{{route('deleteUser',['id'=>$usuario->id])}}">Eliminar</a>
