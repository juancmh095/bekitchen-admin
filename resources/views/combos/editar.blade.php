...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <div class="content container-fluid">
        ...
        <!-- End Page Header -->
        <form action="{{route('updateCombo')}}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-lg-8 mb-3 mb-lg-0">
              ...
              <div class="card mb-3 mb-lg-5">
                ...
                <input type="hidden" name="img" value="{{$combo->banner}}">
                <!-- Header -->
                ...
                <div class="card-body">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="text" class="form-control" name="nombre" id="productNameLabel" placeholder="Combo." value="{{$combo->nombre}}">
                  </div>
                  <!-- End Form -->
              ...
              <table class="table">
                ...
                <tbody>
                  @forEach($productosCombo as $item)
                  <tr>
                    <th>{{$item->producto->nombre}}</th>
                    <th>{{$item->precio}}</th>
                    <th>
                      <a href="{{route('deleteProductoCombo',['id'=>$item->id])}}" class="btn btn-xs btn-danger">Elminiar</a>
                    </th>
                  </tr>
                  @endforeach
                </tbody>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="mb-4">
                   ...
                   <input type="date" class="form-control" name="fecha" id="" value="{{$item->fecha_exp}}">
                  </div>
                  <!-- Form -->
                </div>
                <!-- Body -->
