            ...
            <div class="card mb-3 mb-lg-5">
              ...
              <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <input type="file" class="form-control" name="productName" id="productNameLabel" placeholder="Shirt, t-shirts, etc." aria-label="Shirt, t-shirts, etc." value="Tiro track jacket">
                </div>
                  <!-- End Form -->  
              </div>
              <!-- Body -->
              ...
              <div class="card-body">
                ...
                <div class="js-add-field" data-hs-add-field-options='{
                  ...
                  <div class="row mb-4">
                    ...
                    <!-- End Row -->
                    <div class="col-sm-2">
                      <input type="text" class="form-control" placeholder="Precio" aria-label="Enter tags">
                    </div>
                  </div>
